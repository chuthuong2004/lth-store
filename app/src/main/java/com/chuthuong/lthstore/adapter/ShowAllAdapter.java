...
public class ShowAllAdapter extends RecyclerView.Adapter<ShowAllAdapter.ViewHolder> {
    ...
    public ShowAllAdapter(Context context, List<Product> productList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imgProduct = itemView.findViewById(R.id.show_all_product_img);
            ...
            imgFavorite = itemView.findViewById(R.id.img_favorite_show_all);
        }
    }
}
