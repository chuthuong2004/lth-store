...
public class BestSellingProductAdapter extends RecyclerView.Adapter<BestSellingProductAdapter.ViewHolder> {
    ...
    public BestSellingProductAdapter(Context context, ListProductResponse listProductResponse) {
    ...
    public BestSellingProductAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BestSellingProductAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.best_selling_product_items, parent, false));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imgProduct = itemView.findViewById(R.id.best_selling_product_img);
            name = itemView.findViewById(R.id.best_selling_product_name);
            price = itemView.findViewById(R.id.best_selling_product_price);
            discount = itemView.findViewById(R.id.best_selling_product_discount);
            currentPrice = itemView.findViewById(R.id.best_selling_product_current_price);
            likeCount = itemView.findViewById(R.id.best_selling_product_like_count);
            quantitySold = itemView.findViewById(R.id.best_selling_product_sold);
            ratingBar = itemView.findViewById(R.id.best_selling_product_rating_bar);
            imgFavorite = itemView.findViewById(R.id.img_favorite_best_selling_product);
        }
    }
}
